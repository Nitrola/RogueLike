...
public class Inquisitor extends Mob {
    /**
     * Creer Monstre
     *
     ...
     */
    public Inquisitor(int hp, int mana, float attackSpeed, float criticChance, int physicalDmg, int magicalDmg, float physicalDef, float magicalDef) {
        super(hp, mana, attackSpeed, criticChance, physicalDmg, magicalDmg, physicalDef, magicalDef);

        animIdle = new Animation<Texture>(0.1f, loadFrames(16,"images/combat/Inquisitor/Idle/inquisitor_idle_"));
        animAttack = new Animation<Texture>(0.07f, loadFrames(22,"images/combat/Inquisitor/Attack/inquisitor_attack_"));
